...
let songs = [
  ...
  },
  {
    ...
    coverPath: "cover_images/5.jpg",
  },
  {
    songName: "Let me Love You",
    filepath: "songs/6.mp3",
    coverPath: "cover_images/6.jpg",
  },
  {
    songName: "Unstoppable ",
    filepath: "songs/7.mp3",
    coverPath: "cover_images/7.jpg",
  },
  {
    songName: "Believer",
    filepath: "songs/8.mp3",
    coverPath: "cover_images/8.jpg",
  },
  {
    songName: "Invincible",
    filepath: "songs/9.mp3",
    coverPath: "cover_images/9.jpg",
  },
  {
    songName: "With You - AP Dhillon",
    filepath: "songs/10.mp3",
    coverPath: "cover_images/10.jpg",
  },
];

banner.setAttribute("src", "logo.png");
...
Array.from(document.getElementsByClassName("songItemPlay")).forEach(
  (element) => {
    element.addEventListener("click", (e) => {
      ...
      console.log(songs[id].coverPath);
      banner.setAttribute("src", songs[id].coverPath);
      makeAllPlay();
...
// code for working of next button
